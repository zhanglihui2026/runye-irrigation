...
window.QICAI_SCHEDULE = [
  ...
  { type:'row', dayText:'播种前·土壤处理', nd:'1', stage:'播种前 · 土壤处理', op:'底肥 撒施', count:'1 种',
    list:'<span style="color:#2b7bb0;font-weight:700">消毒</span>：生石灰 50–80 kg/亩',
    mix:'必须独立：与后续底肥间隔 ≥7 天，单独撒施；碱性强，勿与铵态氮/菌剂同施。' },
  { type:'row', dayText:'整地期（生石灰后 ≥7 天）', nd:'2', stage:'整地期（生石灰后 ≥7 天）', op:'底肥 撒施', count:'3 种',
  ...
  { type:'row', dayText:'播后苗前（≤3 天）', nd:'3', stage:'播后苗前（≤3 天）', op:'叶面 喷雾', count:'2 种',
    list:'<span style="color:#c0392b;font-weight:700">除草</span>：精异丙甲草胺 50–100ml ＋ 双氯磺草胺 3–4g',
    mix:'封闭除草组合同桶；（独立）不与杀虫/杀菌/营养混；墒情适中均匀喷。' },
  { type:'row', dayText:'苗后', nd:'4', stage:'苗后', op:'叶面 喷雾', count:'2 种',
  ...
  { type:'row', dayText:'播后 15–20 天', nd:'5', stage:'播后 15–20 天', op:'叶面 ＋灌根', count:'叶面 8 ＋ 灌根 2',
  ...
  { type:'row', dayText:'播后 25–30 天（50% 开花）', nd:'6', stage:'播后 25–30 天（50% 开花）', op:'叶面 ＋灌根', count:'叶面 8 ＋ 灌根 4',
  ...
  { type:'row', dayText:'播后 30–35 天', nd:'7', stage:'播后 30–35 天', op:'灌根 根施', count:'2 种',
    list:'<span style="color:#2b7bb0;font-weight:700">肥/刺激素</span>：水溶肥12-30-8 2kg ＋ 铠仆（海藻）1L',
    mix:'同桶；促下针、抗逆。' },
  { type:'row', dayText:'播后 35–40 天', nd:'8', stage:'播后 35–40 天', op:'叶面 ＋灌根', count:'叶面 8 ＋ 灌根 2',
  ...
  { type:'row', dayText:'播后 55–60 天', nd:'9', stage:'播后 55–60 天', op:'叶面 喷施', count:'11 种（偏多）',
  ...
  { type:'row', dayText:'播后 75–80 天', nd:'10', stage:'播后 75–80 天', op:'叶面 喷施', count:'10 种（偏多）',
